...
if CoreGui:FindFirstChild("IndexUi") then CoreGui:FindFirstChild("IndexUi"):Destroy() end
...
table.insert(Library.Signals, RenderStepped:Connect(function(IndexUi)
    RainbowStep = RainbowStep + IndexUi
